-- Per-fund designations (DONATIONS.md v2): optional list of funds a giver
-- can designate ("General", "Building", "Missions"). Recorded straight into
-- donations.fund by the connect webhook.
alter table public.donation_pages add column funds text[];
